\documentclass[12pt,twoside]{report} % 12 - font size 
...
\usepackage[a4paper, width=150mm, top=25mm, bottom=25mm, bindingoffset=6mm]{geometry} % to specify a proper page formatting 
