...
\section{Polski wkład w rozwój światowej geodezji i nawigacji}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{appendix_vlbi_torun3.eps}
  \caption{Stacja VLBI}
  \label{fig:torun_station}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{appendix_vlbi_torun4.eps}
